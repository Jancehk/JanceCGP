...
BOOL CAdoRecordSet::UpdateBatch(AffectEnum AffectRecords)
{
	...
	{
		TRACE(_T("Warning: UpdateBatch   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::CancelUpdate()
{
	...
	{
		TRACE(_T("Warning: CancelUpdate   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::CancelBatch(AffectEnum AffectRecords)
{
	...
	{
		TRACE(_T("Warning: CancelBatch   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::MoveFirst()
{
	...
	{
		TRACE(_T("Warning: MoveFirst   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MovePrevious()
{
	...
	{
		TRACE(_T("Warning: MovePrevious   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
	return FALSE;	
}
...
long CAdoRecordSet::GetStatus()
{
	...
	{
		TRACE(_T("Warning: GetStatus   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	} 
	return -1;
}
...
long CAdoRecordSet::GetRecordCount()
{
	...
	{
		TRACE(_T("Warning: GetRecordCount   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	} 
}
...
long CAdoRecordSet::GetFieldsCount()
{
	...
	{
		TRACE(_T("Warning: GetFieldsCount   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	} 
}
/*========================================================================
...
long CAdoRecordSet::GetMaxRecordCount()
{
	...
	{
		TRACE(_T("Warning: GetMaxRecordCount   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	}
}
...
long CAdoRecordSet::GetPageCount()
{
	...
	{
		e;
		TRACE(_T("Warning: GetPageCount   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetCacheSize(const long &lCacheSize)
{
	...
	{
		e;
		TRACE(_T("Warning: SetCacheSize  %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
	return TRUE;
}
...
BOOL CAdoRecordSet::SetAbsolutePage(int nPage)
{
	...
	{
		e;
		TRACE(_T("Warning: SetAbsolutePage   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
}
...
long CAdoRecordSet::GetAbsolutePage()
{
	...
	{
		e;
		TRACE(_T("Warning: GetAbsolutePage   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetAbsolutePosition(int nPosition)
{
	...
	{
		e;
		TRACE(_T("Warning: SetAbsolutePosition   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
}
...
long CAdoRecordSet::GetAbsolutePosition()
{
	...
	{
		e;
		TRACE(_T("Warning: GetAbsolutePosition   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetCursorLocation(CursorLocationEnum CursorLocation)
{
	...
	{
		e;
		TRACE(_T("Warning: PutCursorLocation   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
}
...
CursorLocationEnum CAdoRecordSet::GetCursorLocation()
{
	...
	{
		e;
		TRACE(_T("Warning: GetCursorLocation   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return adUseNone;
	}
}
...
BOOL CAdoRecordSet::SetCursorType(CursorTypeEnum CursorType)
{
	...
	{
		e;
		TRACE(_T("Warning: SetCursorType   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
}
...
CursorTypeEnum CAdoRecordSet::GetCursorType()
{
	...
	{
		TRACE(_T("Warning: GetCursorType   %s;%d\n"), e.ErrorMessage(), __LINE__);
...
FieldsPtr CAdoRecordSet::GetFields()
{
	...
	{
		TRACE(_T("Warning: GetFields   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return NULL;
	} 
	return NULL;
}
...
CString CAdoRecordSet::GetFieldName(long lIndex)
{
	...
	{
		TRACE(_T("Warning: GetFieldName   %s;%d\n"), e.ErrorMessage(), __LINE__);
	}
	return strFieldName;
}
...
long CAdoRecordSet::GetFieldAttributes(long lIndex)
{
	...
	{
		TRACE(_T("Warning: GetFieldAttributes   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	}
}
...
long CAdoRecordSet::GetFieldDefineSize(long lIndex)
{
	...
	{
		TRACE(_T("Warning: GetDefineSize   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	}
}
...
long CAdoRecordSet::GetFieldActualSize(long lIndex)
{
	...
	{
		TRACE(_T("Warning: GetFieldActualSize   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return -1;
	}	
}
...
BOOL CAdoRecordSet::IsFieldNull(LPCTSTR lpFieldName)
{
	...
	{
		TRACE(_T("Warning: IsFieldNull   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::PutCollect(long index, const _variant_t &value)
{
	...
	{
		TRACE(_T("Warning: PutCollect   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::GetCollect(long index,  DWORD &value)
{
	...
	try
	{
		...
		case VT_EMPTY:
			...
			break;
		default:
			TRACE(_T("Warning: No R Data Type;%d\n"), __LINE__);
			return FALSE;
		}		
		return TRUE;
	}
...
BOOL CAdoRecordSet::AppendChunk(FieldPtr pField, LPVOID lpData, UINT nBytes)
{
	...
	{
		e;
		TRACE(_T("Warning: AppendChunk   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::GetChunk(LPCTSTR strFieldName, CString &szDate)
{
	BOOL bret = FALSE;
...
BOOL CAdoRecordSet::SetFilter(LPCTSTR lpszFilter)
{
	...
	{
		TRACE(_T("Warning: SetFilter   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
}
...
_variant_t CAdoRecordSet::GetBookmark()
{
	...
	{
		TRACE(_T("Warning: GetBookmark   %s;%d\n"), e.ErrorMessage(), __LINE__);
	}
...
BOOL CAdoRecordSet::SetBookmark(_variant_t varBookMark)
{
	...
	{
		TRACE(_T("Warning: SetBookmark   %s;%d\n"), e.ErrorMessage(), __LINE__);
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::RecordBinding(CADORecordBinding &pAdoRecordBinding)
{
	...
	{
		TRACE(_T("Warning: RecordBinding   %s;%d\n"), e.ErrorMessage(), __LINE__);
		return FALSE;
	}
}
