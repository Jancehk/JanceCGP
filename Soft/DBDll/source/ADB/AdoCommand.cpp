								  ...
								  _variant_t Value)
{
	...
	{
		TRACE(_T("Warning: CreateParameter  %s;%d\n"), e.ErrorMessage(),__LINE__);
		return NULL;
	} 
}
...
BOOL CAdoCommand::SetCommandText(LPCTSTR lpstrCommand)
{
	...
	{
		TRACE(_T("Warning: PutCommandText  %s;%d\n"), e.ErrorMessage(),__LINE__);
		return FALSE;
	} 
}
...
BOOL CAdoCommand::SetConnection(CAdoConnection *pConnect)
{
	...
	{
		TRACE(_T("Warning: SetConnection  %s;%d\n"), e.ErrorMessage(),__LINE__);
		return FALSE;
	} 
}
/*========================================================================
...
BOOL CAdoCommand::SetCommandType(CommandTypeEnum CommandType)
{
	...
	{
		TRACE(_T("Warning: PutCommandType  %s;%d\n"), e.ErrorMessage(),__LINE__);
		return FALSE;
	} 
}
...
BOOL CAdoCommand::SetCommandTimeOut(long lTime)
{
	...
	{
		TRACE(_T("Warning: SetCommandTimeOut  %s;%d\n"), e.ErrorMessage(),__LINE__);
		return FALSE;
	} 
}
...
_ParameterPtr CAdoCommand::GetParamter(LPCTSTR lpstrName)
{
	...
	{
		TRACE(_T("Warning: GetParamter  %s;%d\n"), e.ErrorMessage(),__LINE__);
		return NULL;
	} 
}
...
BOOL CAdoParameter::SetPrecision(char nPrecision)
{
	...
	{
		TRACE(_T("Warning: SetPrecision  %s;%d\n"), e.ErrorMessage(),__LINE__);
		return FALSE;
	}
}
...
DataTypeEnum CAdoParameter::GetType()
{
	...
	{
		TRACE(_T("Warning: SetDirection  %s;%d\n"), e.ErrorMessage(),__LINE__);
		return adEmpty;
	}
}
