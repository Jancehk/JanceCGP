...
typedef enum _VOS_CONNECT_TYPE_NUM_T{
	CPSS_CONNECT_SUB_SELF = 3,
	CPSS_CONNECT_SUB_DBSVR,
	CPSS_CONNECT_SUB_XCAP,
	CPSS_CONNECT_SUB_MONEY,
	CPSS_CONNECT_SUB_NUM,
};

typedef enum _VOS_CONNECT_NUM_T{
	CPSS_CONNECT_SELF = 20,
	CPSS_CONNECT_FW,
	CPSS_CONNECT_TELNET,
	CPSS_CONNECT_FTP,
	CPSS_CONNECT_DBSVR,
...
typedef enum CPSS_PRINT_LEVEL{
	CPSS_PRINT_LEVEL_CLOSE,			//什么都不打印	
	CPSS_PRINT_LEVEL_1,				//一级别
	CPSS_PRINT_LEVEL_2,				//二级别
	CPSS_PRINT_LEVEL_3,				//三级别
	CPSS_PRINT_LEVEL_4,				//四级别
	CPSS_PRINT_LEVEL_5,				//无级别
	CPSS_PRINT_LEVEL_6				//六级别
};
