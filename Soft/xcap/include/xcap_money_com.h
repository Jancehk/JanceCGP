...
#define XCAP_MONEY_CPUID		cpss_get_cpuid_pid(CPSS_SYSTEM_TYPE_MONEY, CPSS_SUBSYS_TYPE_FW, CPSS_GET_TYPE_CPUID)
#define XCAP_MONEY_PID			cpss_get_cpuid_pid(CPSS_SYSTEM_TYPE_MONEY, CPSS_SUBSYS_TYPE_FW, CPSS_GET_TYPE_PID)
