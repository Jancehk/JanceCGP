...
typedef enum XCAP_REQ_FIELDS {
	...
	XCAP_REQ_FIELDE_UA_CPU,
};
typedef enum XCAP_RES_CODE{
	XCAP_RES_CODE_100=100,
	XCAP_RES_CODE_101,
	XCAP_RES_CODE_200=200,
	XCAP_RES_CODE_201,
	XCAP_RES_CODE_202,
	XCAP_RES_CODE_203,
	XCAP_RES_CODE_204,
...
/* Xcap Server root */
typedef struct _XCAP_SERVER_MGR_T
{
	VOS_CHAR	strServerName[32];
	VOS_UINT32	ulSystemID;
	VOS_UINT32	ulSubsysID;
}XCAP_SERVER_MGR, *pXCAP_SERVER_MGR;
...
static XCAP_FIELDS_TEMP g_fields_req[] = {
	...
	{ XCAP_REQ_FIELDE_UA_CPU, "UA-CPU: ", "", 0 },
};
